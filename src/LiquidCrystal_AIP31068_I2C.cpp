...
void LiquidCrystal_AIP31068_I2C::setReg(uint8_t addr, uint8_t data) {
...
void LiquidCrystal_AIP31068_I2C::setRGB(uint8_t r, uint8_t g, uint8_t b) {
  setReg(REG_RED, r);
  setReg(REG_GREEN, g);
  setReg(REG_BLUE, b);
}
...
uint8_t LiquidCrystal_AIP31068_I2C::status() {
  return 0;
}
uint8_t LiquidCrystal_AIP31068_I2C::keypad() {
  return 0;
}
uint8_t LiquidCrystal_AIP31068_I2C::init_bargraph(uint8_t graphtype) {
  return 0;
}
